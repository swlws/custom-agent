    ...
    >
      ...
      <div className="flex flex-col gap-1 px-2 py-3">
        ...
        >
          ...
          <span className={`overflow-hidden whitespace-nowrap text-[13px] transition-all duration-200 ${open ? "w-auto opacity-100" : "w-0 opacity-0"}`}>
            {open ? "收起侧边栏" : ""}
          </span>
        </button>
      ...
      {/* 下方工具按钮区 */}
      <div className="flex h-[88px] flex-col justify-center gap-1 border-t border-gray-200 px-2 dark:border-[#2f2f2f]">
        {/* 设置按钮 */}
        <button
